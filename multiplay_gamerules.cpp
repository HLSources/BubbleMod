...
void CHalfLifeMultiplay :: PlayerSpawn( CBasePlayer *pPlayer )
{
	...
	// BMOD Edit - Dont give spectators any weapons
...
void CHalfLifeMultiplay::DeathNotice( CBasePlayer *pVictim, entvars_t *pKiller, entvars_t *pevInflictor )
{
	...
	else if ( pKiller->flags & FL_CLIENT )
	{
		...
		if (pVictim->BMOD_WasSpawnKilled() && 
			strcmp(killer_weapon_name, "tripmine") )
		{
		...
		if ( bm_matchkills.value &&
			 strcmp(killer_weapon_name, "tripmine") &&
			 strcmp(killer_weapon_name, "snark") &&
				(
...
==============
*/
// BMOD Edit - added custom changelevel 
/*
...
#define MAX_MOTD_LENGTH   (MAX_MOTD_CHUNK * 16)
